...
class NativeTimelineWindow(ctk.CTkToplevel):
    ...
    def _draw_scene(self):
        ...
        canvas_width = LEFT_MARGIN + (max_time + 2) * PIXELS_PER_SEC
        ...
        for t in range(math.ceil(max_time) + 2):
            x = LEFT_MARGIN + t * PIXELS_PER_SEC
        ...
        for item in items:
            ...
            start_x = LEFT_MARGIN + item.get('start', 0) * PIXELS_PER_SEC
            width = item.get('duration', 0) * PIXELS_PER_SEC
