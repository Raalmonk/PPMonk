...
class PlaceholderTalent(Talent):
    def apply(self, player, spell_book): return None
...
TALENT_DB = {
    ...
    '6-2': PlaceholderTalent('Cyclone Drift'),
    '6-2_b': PlaceholderTalent('Crashing Fists'), # Alternative
    
    '6-3': PlaceholderTalent('Spiritual Focus'),
    '6-3_b': PlaceholderTalent('Drinking Horn Cover'), # Alternative
    ...
    '7-3_b': UnlockSpellTalent('Strike of the Windlord', 'SOTWL'), # Alternative
    ...
    '8-5': PlaceholderTalent('Echo Technique'),
    '8-5_b': PlaceholderTalent('Revolving Whirl'), # Alternative
    ...
    '10-6_b': PlaceholderTalent('Hurricane Vault'), # Alternative
    
    '10-7': PlaceholderTalent('Path of Jade'),
    '10-7_b': PlaceholderTalent('Singularly Focused'), # Alternative
