...
def run():
    print(">>> 初始化训练环境 (Pure Math: Gamma=1.0)...")
    env = MonkEnv()
    ...
    # [核心修改] Gamma = 1.0
    # 这意味着 AI 认为第 20 秒的 1 点伤害，和第 1 秒的 1 点伤害一样值钱。
    # 这是解决短视问题的数学根本解。
    model = MaskablePPO(
        "MlpPolicy",
        env,
